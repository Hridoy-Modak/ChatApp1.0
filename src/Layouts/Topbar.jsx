...
const Topbar = () => {
  return (
      <div className="h-[100%] topbar w-full h-full shadow-lg flex justify-between items-center">
        ...
        <div className=" py-1 [clip-path:polygon(25%_0,_100%_0%,_100%_100%,_0%_100%)] h-full bg-[#5873FF] opacity-85 w-[35%]">
